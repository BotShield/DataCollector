...
-- Dient zum Aufbau einer neuen Twitter-Datenbank

DROP SEQUENCE IF EXISTS url_seq,param_seq,place_seq,geoloc_seq,entity_seq,hashtag_seq,usermention_seq CASCADE;
...
CREATE SEQUENCE hashtag_seq; -- eine Sequence für die IDs eines Hashtags.
...
(
    ...
    UserMentionEntities_id bigint REFERENCES T_Entity(ID),
